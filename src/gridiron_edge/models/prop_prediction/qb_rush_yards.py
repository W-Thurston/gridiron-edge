...
Predicts a QB's rushing yards for a given game. Uses the same ElasticNet
baseline as other prop models — champion/challenger with tree models
will be added via the standard promotion gate pattern.
...
class QBRushYardsTrainer(PropTrainer):
    """QB rushing yards prop model using ElasticNet regression."""
    ...
    def spec(self) -> PropModelSpec:
        ...
        return PropModelSpec(
            ...
            position_filter=["QB"],
            description="QB rushing yards — ElasticNet regression on rolling + matchup features",
        )
