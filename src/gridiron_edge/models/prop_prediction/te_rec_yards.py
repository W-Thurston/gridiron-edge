...
Predicts a TE's receiving yards for a given game using player rolling
...
_FEATURE_COLUMNS: list[str] = [
    ...
    # --- Opponent matchup features (TE-specific) ---
    "opp_te_rec_yards_allowed_L6",
    "opp_te_rec_yards_allowed_rank_L6",
    "opp_te_rec_tds_allowed_L6",
    "opp_te_rec_tds_allowed_rank_L6",
    "opp_te_targets_allowed_L6",
    "opp_te_targets_allowed_rank_L6",
]


class TERecYardsTrainer(PropTrainer):
    """TE receiving yards prop model using Ridge regression."""
    ...
    def spec(self) -> PropModelSpec:
        ...
        return PropModelSpec(
            ...
            position_filter=["TE"],
            description="TE receiving yards — Ridge regression on rolling + matchup features",
        )
